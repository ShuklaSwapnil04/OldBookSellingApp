						...
						<table class="table table-striped">
					    ...
					    
					       {
								...
								<tr>
									...
									<td><%=c.getAuthor() %></td>
									<td><%=c.getPrice() %></td>
									<td><a href="remove_book?bid=<%=c.getBid() %>&&uid=<%=c.getUserId() %>&&cid=<%=c.getCartId() %>" class="btn btn-danger">Remove</a></td>
								</tr>
<%
					       }
%>
						...
						<input type="hidden" value="${userobj.id }"name="id">
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									<label for="inputEmalid">Name</label><input type="text" name="username"
										class="form-control" id="inputEmailid" value="${userobj.name}" required>
								</div>
								<div class="form-group col-md-6">
								...
								<div class="form-group col-md-6">
									<label for="inputEmalid">Phone Number</label><input
										type="number" class="form-control" name="phno"id="inputEmailid" value="${userobj.phno }" required>
								</div>
								<div class="form-group col-md-6">
								...
								<div class="form-group col-md-6">
									<label for="inputPassword4">Landmark</label><input type="text" name="landmark"
										class="form-control" id="inputPassword4" required>
								</div>
								<div class="form-group col-md-6">
